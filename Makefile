...
install: build completions
	...
	install -Dm755 target/release/clockiectl $(DESTDIR)$(BINDIR)/clockiectl
	install -Dm644 target/completions/clockie.bash $(DESTDIR)$(COMPLETIONS_BASH)/clockie
	install -Dm644 target/completions/clockiectl.bash $(DESTDIR)$(COMPLETIONS_BASH)/clockiectl
	install -Dm644 target/completions/_clockie $(DESTDIR)$(COMPLETIONS_ZSH)/_clockie
	install -Dm644 target/completions/_clockiectl $(DESTDIR)$(COMPLETIONS_ZSH)/_clockiectl
	install -Dm644 target/completions/clockie.fish $(DESTDIR)$(COMPLETIONS_FISH)/clockie.fish
	install -Dm644 target/completions/clockiectl.fish $(DESTDIR)$(COMPLETIONS_FISH)/clockiectl.fish
...
completions: build
	...
	target/release/clockiectl completions bash > target/completions/clockiectl.bash
	target/release/clockiectl completions zsh > target/completions/_clockiectl
	target/release/clockiectl completions fish > target/completions/clockiectl.fish

uninstall:
	rm -f $(DESTDIR)$(BINDIR)/clockie
	rm -f $(DESTDIR)$(BINDIR)/clockiectl
	rm -f $(DESTDIR)$(COMPLETIONS_BASH)/clockie
	rm -f $(DESTDIR)$(COMPLETIONS_BASH)/clockiectl
	rm -f $(DESTDIR)$(COMPLETIONS_ZSH)/_clockie
	rm -f $(DESTDIR)$(COMPLETIONS_ZSH)/_clockiectl
	rm -f $(DESTDIR)$(COMPLETIONS_FISH)/clockie.fish
	rm -f $(DESTDIR)$(COMPLETIONS_FISH)/clockiectl.fish
